...
class IbaseValue(Iexpression,
				 attr_interfaces.IbaseValueAttrGroup,
				 qti_interfaces.IConcrete):
	pass

class Ivariable(Iexpression,
				attr_interfaces.IvariableAttrGroup,
				qti_interfaces.IConcrete):
	pass

class Idefault(Iexpression,
			   attr_interfaces.IdefaultAttrGroup,
			   qti_interfaces.IConcrete):
	pass

class Icorrect(Iexpression,
			   attr_interfaces.IcorrectAttrGroup,
			   qti_interfaces.IConcrete):
	pass

class ImapResponse(Iexpression,
				   attr_interfaces.ImapResponseAttrGroup,
				   qti_interfaces.IConcrete):
	pass

class ImapResponsePoint(Iexpression,
						attr_interfaces.ImapResponsePointAttrGroup,
						qti_interfaces.IConcrete):
	pass

class ImathConstant(Iexpression,
					attr_interfaces.ImathConstantAttrGroup,
					qti_interfaces.IConcrete):
	pass
...
class IrandomInteger(Iexpression,
					 attr_interfaces.IrandomIntegerAttrGroup,
					 qti_interfaces.IConcrete):
	pass
	
class IrandomFloat(Iexpression,
				   attr_interfaces.IrandomFloatAttrGroup,
				   qti_interfaces.IConcrete):
	pass
...
class ItestVariables(Iexpression,
					 attr_interfaces.ItestVariablesAttrGroup,
					 qti_interfaces.IConcrete):
	pass

class IoutcomeMaximum(Iexpression,
					  attr_interfaces.IoutcomeMaximumAttrGroup,
					  qti_interfaces.IConcrete):
	pass

class IoutcomeMinimum(Iexpression,
					  attr_interfaces.IoutcomeMinimumAttrGroup,
					  qti_interfaces.IConcrete):
	pass
...
class IroundTo(Iexpression,
			   attr_interfaces.IroundToAttrGroup,
			   qti_interfaces.IConcrete):

	expression = Object(Iexpression,
						title="The eval sub-expression",
						required=True)

class IstatsOperator(Iexpression,
					 attr_interfaces.IstatsOperatorAttrGroup,
					 qti_interfaces.IConcrete):
...
class Imax(Iexpression, qti_interfaces.IConcrete):
	...
	expression = List(Object(Iexpression),
					  title='The sub-expressions',
					  min_length=1,
					  required=True)
...
class Irepeat(Iexpression,
			  attr_interfaces.IrepeatAttrGroup,
			  qti_interfaces.IConcrete):
...
class Iordered(Iexpression, qti_interfaces.IConcrete):
	...
	expression = List(Object(Iexpression),
					  title='The ordered sub-expressions',
					  min_length=0,
					  required=True)
...
class Iindex(Iexpression,
			 attr_interfaces.IindexAttrGroup,
			 qti_interfaces.IConcrete):
...
class IfieldValue(Iexpression,
				  attr_interfaces.IfieldValueAttrGroup,
				  qti_interfaces.IConcrete):
...
class Imember(Iexpression, qti_interfaces.IConcrete):
	...
	expression = List(Object(Iexpression),
					  min_length=2,
					  max_length=2,
					  title="The ordered eval sub-expressions",
					  required=True)
...
class Isubstring(Iexpression,
				 attr_interfaces.IsubstringAttrGroup,
				 qti_interfaces.IConcrete):
...
class Iand(Iexpression, qti_interfaces.IConcrete):
	...
	expression = List(Object(Iexpression),
					  min_length=1,
					  title="The eval sub-expressions",
					  required=True)
...
class IanyN(Iexpression,
			attr_interfaces.IanyNAttrGroup,
			qti_interfaces.IConcrete):
...
class IstringMatch(Iexpression,
				   attr_interfaces.IstringMatchAttrGroup,
				   qti_interfaces.IConcrete):
...
class IpatternMatch(Iexpression,
					attr_interfaces.IpatternMatchAttrGroup,
					qti_interfaces.IConcrete):
...
class Iequal(Iexpression,
			 attr_interfaces.IequalAttrGroup,
			 qti_interfaces.IConcrete):
...
class IequalRounded(Iexpression,
					attr_interfaces.IequalRoundedAttrGroup,
					qti_interfaces.IConcrete):
...
class Iinside(Iexpression,
			  attr_interfaces.IinsideAttrGroup,
			  qti_interfaces.IConcrete):
...
class IcustomOperator(Iexpression,
					  attr_interfaces.IcustomOperatorAttrGroup,
					  qti_interfaces.IConcrete):
